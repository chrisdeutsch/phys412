...
Die Genauigkeit in der Spaltbreite $d$ eines typischen Messschiebers ist $\Delta d = \SI{0.02}{\milli\metre}$ trotz einer Auflösung von \SI{0.01}{\milli\metre} \cite{messschieber_katalog}.
\begin{table}[h]
	\centering
