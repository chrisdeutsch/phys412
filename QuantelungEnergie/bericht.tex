...
\begin{table}[h]
	...
	\caption{Ergebnisse der Umrechnung der Winkel. $\Delta \alpha = \SI{8.8}{\milli\radian}$ und $\Delta \beta = \SI{9.8}{\milli\radian}$}
...
\begin{figure}[h]
	...
	\caption{Bestimmung der Gitterkonstante aus den gemessenen Einfalls- und Ausfallswinkeln}
...
\begin{table}[h]
	...
	\caption{Linearisierte Werte zur Bestimmung der Rydberg-Konstante}
