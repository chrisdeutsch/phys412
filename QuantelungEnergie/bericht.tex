...
\end{align*}
Die Ein- und Ausfallswinkel werden dabei analog zu Abschnitt \ref{sssec:gitterkonstanten} aus den gemessenen Gitter- und Bankwinkeln in Tabelle \ref{tab:gitterkonstante_messdaten} (hier jedoch ohne Korrektur, da bei der Messung die Strichskala auf die Wasserstoff-Linie zentriert wurde).
...
\begin{align*}
  \mathrm{d}\lambda = \frac{\del \lambda}{\del \alpha} \mathrm{d}\alpha + \frac{\del \lambda}{\del \beta} \mathrm{d}\beta
\end{align*}
In linearer Approximation ($\Delta \alpha = \num{0}$) folgt somit:
\begin{align*}
  \Delta \lambda &= \frac{\del \lambda}{\del \beta} \cdot \Delta \beta \\
  &= g \cos(\beta) \Delta \beta
\end{align*}
