...
Bei Probe 1 finden wir so durch Vergleich mit dem Referenzspektrum, dass das höchste Peak Eisen entspricht.
Das weiter links liegende Peak kann mit der abgelesenen Energie und \cite{booklet} zu Chrom bestimmt werden, genau wird das sehr kleine Peak bei ca. \SI{10}{\kilo\electronvolt} zu Wolfram zugeordnet, da es im Referenzspektrum kaum zu erkennen ist (entspricht laut \cite{booklet} der $L\beta_1$ Linie).
