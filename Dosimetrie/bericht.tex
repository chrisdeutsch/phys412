...
\end{align}
Strahlensatz: $a(s) = \frac{a_0}{s_0} \cdot s$ und $b(s) = \frac{b_0}{s_0} \cdot s$
\begin{align}
...
\end{align}
Annahme Fehler $\Delta  = \SI{0.05}{cm}$
\begin{align}
	V = \SI{125 +- 11}{\centi\meter\cubed}
\end{align}
Gauß'sche Fehlerfortpflanzung auf Angabe der expliziten Formel wird verzichtet.\\
\\
\textbf{Dichte von Luft:}\\
Messwerte:
\begin{align}
...
\begin{align}
	T_0 = \SI{273}{\kelvin}\\
	p_0 = \SI{1013}{hPa}\\
	\rho_0 = \SI{1.293}{\kilogram\per\metre\cubed}
\end{align}
...
\begin{align}
	m = \SI{1.45 +- 0.13e-4}{kg} = \SI{145 +- 13}{mg}
\end{align}
