...
\begin{align}
	...
	\epsilon_0 &= \num{2.401 +- 0.020}
\end{align}
Aus dem Endpunkt $\epsilon_0$ (d.h. die maximalen Energie) kann nun die Zerfallsenergie $Q$ berechnet werden.
Sie ergibt sich durch Abziehen der Ruhemasse des Elektrons und Umwandlung der dimensionslosen Größen in natürliche Einheiten:
\begin{align}
