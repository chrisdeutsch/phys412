...
fit[x=4.232:13.5] f(x) './messwerte/modenabstand/ALL0028.txt' using ($1*1000):($2*1000):(1) via a1, b1, a2, b2, a3, b3, a4, b4, a5, b5, a6, b6, a7, b7, a8, b8, a9, b9, a10, b10, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, d
...
plot 	'./messwerte/modenabstand/ALL0028.txt' using ($1*1000):($2*1000):(1) with yerrorbars ls 2 lw 2 t'Messwerte',\
