...
Im Folgenden werden zwei Spitzenherstellungsmethoden angesprochen, dabei wird die konkrete Vorgehensweise im Abschnitt Durchführung erläutert.
...
\begin{itemize}
  ...
  Die dabei entstehenden gestreuten Elektronen, Sekundärelektronen, Bremsstrahlung etc. können über Detektoren eine Abbildung des Objekt erzeugen.
\end{itemize}
...
Die so entstandenen Spitzen ließen leider auch keine gute Messung zu, so dass wir am Ende des zweiten Versuchstages auf bereits erstellte Referenzbilder für die Auswertung zurückgreifen mussten.
...
Teilweise konnte auch gar keine Annäherung durchgeführt werden, so dass die Kontroll-LEP von orange direkt auf rot sprang, was bedeutet, dass die Spitze in die Probe gefahren ist.
...
hier evtl. Bild von dem Bohrereinsatz einfügen?
