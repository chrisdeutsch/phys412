...
fit[x=0.83:1.17] t(x) './messwerte/b7.txt' using 1:2:(0.4) via a1, a2, a3, b1, b2, b3, c1, c2, c3, d
...
plot 	'./messwerte/b7.txt' using 1:2:(0.0025):(0.4) with xyerrorbars t'Messwerte' ls 1,\
