...
\begin{itemize}
  ...
  Die Gegenspannung bei der dies einsetzt, dient als erste Abschätzung der Grenzspannung, sodass der Messbereich entsprechend gewählt werden kann.
  \item Messung der Kennlinie: Es wird bei der Messung bei einer Gegenspannung von $U = \SI{0}{\volt}$ begonnen, welche (hochgeregelt wird s.d. etwas mehr als 10 Werte im quadratischen Bereich liegen).
\end{itemize}
...
\end{align}
Diese sind zusammen mit den Messdaten in den Abbildungen \ref{fig:aufspaltung_rot}, \ref{fig:aufspaltung_tuerkis} und \ref{fig:aufspaltung_blau} dargestellt.
...
Den Fehler des Winkels schätzen wir zu \SI{0.003}{\degree} ab; dies folgt aus der Überlegung, dass wir einen Winkelbereich von ca. \SI{5.5}{\degree} auf \num{2048} Pixeln messen.
\begin{figure}[h]
\centering
