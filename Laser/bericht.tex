...
Diese Verluste führen zu einer Änderung der Schwellenbedingung\footnote{Die Schwellenbedingung ist dadurch gegeben, dass die Kleinsignalverstärkung $\gamma(\nu)$ des Lasers der Verlustkonstante $\alpha(\nu)$ entspricht. Unterhalb dieser Schwelle reicht die Verstärkung durch stimulierte Emission nicht aus, um die Laseroszillation zu gewährleisten.} für Laseroperation, was bei dieser Messmethode ausgenutzt wird, um eine zum Strahlradius $w$ proportionale Größe $d$ zu messen.
