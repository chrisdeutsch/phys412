...
fit[x=0.06:0.105] t(x) './messwerte/CCD/tuerkis1.txt' using 1:2:(0.2) via a1, a2, b1, b2, c1, c2, d
...
plot 	'./messwerte/CCD/tuerkis1.txt' using 1:2:(0.2) with yerrorbars t'Messwerte' ls 1,\
