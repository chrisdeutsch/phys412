...
Anhaltspunkt dafür ist, dass der untere Teil der abfallenden Flanke von Eisen sehr breit ist, breiter als im Referenzspektrum, so dass vermutet werden kann, hier ein weiteres Peak zu finden.
Der flache Peak bei ca. \SI{10}{\kilo\electronvolt} gehört auch zu Eisen, wir finden ihn auch im Referenzspektrum.
Das weiter links liegende Peak (ca. \SI{5.5}{\kilo\electronvolt}) kann mit der abgelesenen Energie und \cite{booklet} zu Chrom bestimmt werden.
