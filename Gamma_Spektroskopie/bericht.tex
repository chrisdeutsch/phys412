...
\end{table}
Berechnet man nun durch Integration die Anzahl der Ereignisse in den verschiedenen Peaks so erhält man Tabelle \ref{tab:ptt_halb}.
\begin{table}[ht]
	\centering
	\resizebox{\textwidth}{!}{
...
\begin{figure}[h]
	...
	\caption{Relative Effizienz des Ge-Halbleiterdetektors bei verschiedenen Energien $E_\gamma$}
