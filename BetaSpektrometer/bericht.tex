...
\begin{figure}[h]
	...
	\caption{Kurie-Darstellung des Spektrums von \isotope[204]{Tl}. Die Anpassung einer Geraden an den linearen Teil des Graphens (FITRANGE) ergibt den Endpunkt $\epsilon_0 = \num{2.38 +- 0.05}$ (TODO).}
...
\begin{figure}[h]
	...
	\caption{Kurie-Darstellung des Spektrums von \isotope[22]{Na}. Die Anpassung einer Geraden an den linearen Teil des Graphens (FITRANGE) ergibt den Endpunkt $\epsilon_0 = \num{2.1 +- 0.05}$ (TODO).}
