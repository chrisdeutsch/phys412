...
\end{align}
gegeben ist.
Folglich wird die Anzahl der Ereignisse stets vom Untergrund befreit sein, sodass entgegen der Bezeichnung in Gleichung \ref{eq:untergrundkorr_fehler} mit $N$ bezeichnen.
