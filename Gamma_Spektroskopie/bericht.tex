...
\begin{itemize}
	...
	\begin{align*}
		\mathcal{E} = \frac{\text{Anzahl der Ereignisse}}{\text{Anzahl der in Richtung des Detektors emittierten Teilchen}}
	\end{align*}
	...
	\begin{align}
		...
		\mathcal{E}_\mathrm{int} = \frac{N}{A \cdot T \cdot \frac{\pi r^2}{4\pi \, d^2}}
	\end{align}
	wobei $N$ die Anzahl der detektierten Ereignisse ist.
\end{itemize}
...
Diese stehen dann nicht mehr zur Messung zur Verfügung, können allerdings nach einer gewissen Zeit wieder zurück in das Leitungsband gelangen oder aber mit einem ebenfalls eingefangenen Loch rekombinieren.
