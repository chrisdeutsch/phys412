...
Die dabei frei werdende Energie wird in Form von hochenergetischen Photonen, s.g. Gamma-Quanten ausgesendet, deren Energiebereich von wenigen \si{\kilo\electronvolt} bis zu mehreren \si{\mega\electronvolt} reicht.
