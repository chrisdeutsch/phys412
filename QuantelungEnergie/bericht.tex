...
\caption{Isotopieaufspaltung blau 1}
\label{fig:aufspaltung_blau1}
\end{figure}

\begin{figure}
\centering
\input{./plots/aufspaltung/blau2.tex}
\caption{Isotopieaufspaltung blau 2}
\label{fig:aufspaltung_blau2}
\end{figure}
