...
A function was implemented to calculate the oberserved right ascension and declination from the asteroid's guessed position.
The difference $\vec{r}$ between the positions from observer and asteroid is then corrected by earth's ecliptic of \SI{23.4}{\degree} where a rotation matrix is used.
