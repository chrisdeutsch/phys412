...
In der Regel ist die Linienform dieses Pulses für Teilchen verschiedener Energien gleich, sodass man die Impulshöhe ebenfalls eine zur Energie des einfallenden Teilchens proportionale Größe ist.
...
\end{table}
Die untergrundbereinigten Spektren wurden im Anhang \ref{fig:spektren_szinti} dargestellt.
...
Alle untergrundbereinigten Spektren wurden im Anhang \ref{fig:spektren_szinti} zusammengestellt.
\begin{figure}[hp]
	\centering
	\begin{subfigure}[b]{0.65\textwidth}
...
Diesen bilden in den meisten Fällen die beiden natürlichen Zerfallsreihen von \isotope[232]{Th} und \isotope[238]{U}, aber auch die \isotope[235]{U}-Zerfallsreihe ist einmal (wenn auch nicht eindeutig, man beachte auch die Fußnote) vorhanden.
