...
Wir lassen die Parameter nun an jeweils 4 Maxima pro Datensatz anpassen, wobei wir die Maxima mit $i$ von links nach rechts durchnummerieren, beginnend bei dem Maximum zwischen \SI{15}{\kilo\volt} und \SI{20}{\kilo\volt}, da das davor liegende Maximum in keinem Fall gut gefittet werden kann.
...
\begin{align*}
\Delta E = \SI{4.922+-0.027}{\electronvolt}
\end{align*}
