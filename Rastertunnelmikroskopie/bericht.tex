...
Laut Bedienungsanleitung des Rastertunnelmikroskops sollte die Kurve in der unteren Bildhälfte zwar möglichst flach und stetig verlaufen, jedoch liefert das grafische Ergebnis eine recht gute Darstellung.
Es sind deutlich die erwarteten Ergebnisse zu sehen.
So finden wir an den hellen Punkten (=Maxima) die Atome der oberen Gitterebene und sehen an den dunklen Punkten ebenfalls, dass der Strom dort sehr gering ist; dort überlappen die Atome in der oberen und unteren Ebene so, dass die Ladungsträgerdichte an der Oberfläche sehr gering ist.
...
Die Maxima sind nicht mehr so gut zu erkennen wie in Abbildung \ref{fig:ref_ptir}, die dunklen Stellen scheinen hier keine Minima zu sein, sondern sie bilden die Kante zwischen zwei Hexagons.
