...
plot "./messdaten/materialanalyse/probe1.txt" using 1:2 with lines t'Messwerte' axis x1y1, "./messdaten/materialanalyse/probe1.txt" using ((-725.235+67.5266*($1))/1000):2 with lines t' ' axis x2y1 lt 1 lc 1
