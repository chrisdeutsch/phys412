...
\caption{Zuordnung der Linien aus Abbildung \ref{fig:anode3} an das charakteristische Röntgenspektrum von Wolfram und Vergleich mit den Literaturwerten}
\label{tab:ausw_grob}
\end{table}
...
\bibitem{crc}
  ...
  \emph{Crystallographic Data on Mineals}
