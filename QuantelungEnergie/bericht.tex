...
Für Temperaturen über dem absoluten Nullpunkt nähert sich der Photostrom asymptotisch an $0$, wobei für eine ideale Photozelle ein Schnittpunkt mit der $U$-Achse existiert (vgl. \cite{prak_uheidelberg}).
...
\end{align}
Wegen der asymptotischen Annäherung wird darum die Wurzel des Photostroms aufgetragen, um aus der entstehenden linearen Abhängigkeit die Nullstelle $U_0$ extrapolieren zu können, bei der Photostrom im idealen Fall verschwinden sollte.
...
Da die Wellenlängen der ersten vier Linien der Balmer-Serie bestimmt wurden, kann nun mithilfe der Rydberg-Formel (Gl. \ref{eq:rydberg_formel}) und einer geeigneten Linearisierung eine Bestimmung der Rydberg-Konstanten durchgeführt werden.
...
Ursache hierfür ist offenbar die Anpassung mit \textit{Gnuplot} und die Tatsache, dass die Linien nicht ganz zentral in der CCD-Zeile lagen.
...
Auch das Plancksche Wirkungsquantum konnte mit wesentlich höherer Genauigkeit, als dies beim Photoeffekt der Fall war, bestimmt werden.
