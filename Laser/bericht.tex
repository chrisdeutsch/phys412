...
\begin{itemize}
	...
	\item \textbf{stimulierte Emission:} Ein Photon des Lichtfeldes der Energie $\hbar \omega_{12}$ induziert einen Übergang vom Zustand $\ket{2}$ nach $\ket{1}$, unter Emission eines zum Photon des Lichtfeldes identischen Photons.\textbf{vielleicht noch was zur Kohärenz der beiden Photonen, Kohärenz macht ja eigentlich erst Laserlicht aus}
...
\textbf{Hier fehlt noch was, glaube ich}
Krümmungsradius:
\begin{align}
...
Bemerkenswert ist, dass man bei den letzten\footnote{bezüglich des Abstandes $z$ von der Strahltaille} Messpunkten im Strahlprofil ein systematisches Abknicken \textbf{sagt man "`Abknicken"'?} beobachten kann.
...
Mit dieser Vorgehensweise erhält man für alle vier Resonatorlängen die in Tabelle \ref{tab:modenabstand} \textbf{Ungültige REF!} eingetragenen Ergebnisse für den Abstand zweier Moden und den longitudinalen Modenabstand.
\begin{table}[htb]
\centering
