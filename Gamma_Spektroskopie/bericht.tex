...
Zur Bestimmung des Peak-to-Total Verhältnisses muss die Gesamtzahl aller Ereignisse $\Sigma$ in den Spektren bestimmt werden.
Diese erhält man durch Subtraktion der Gesamtzahl der Ereignisse der Untergrundmessung $\Sigma_\mathrm{Untergrund}$ von der untergrundbehafteten Ereigniszahl des Spektrums $\Sigma_0$:
\begin{align}
	\Sigma = \Sigma_\mathrm{0} - \Sigma_\mathrm{Untergrund}
\end{align}
