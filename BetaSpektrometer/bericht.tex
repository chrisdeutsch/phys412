...
Nach Gleichung \ref{eq:impuls_radius} ist das Produkt von Magnetfeld $B$ und Bahnradius $\rho$ charakteristisch für den Impuls des Elektrons.
...
An Gleichung \ref{eq:betatronwinkel} ließt man nach quadrieren ab:
\begin{align}
...
Damit folgt aus Gleichung \ref{eq:betatronwinkelverhaeltnis} der gesamte Winkel der Elektronenbahn im Spektrometer.
