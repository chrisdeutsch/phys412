...
set output './plots/strahlradien/strahlradius_80cm.tex'
...
fit w_fit(x) './messwerte/strahlradien/strahlradien_80cm.txt' using 1:($3/2.0):($4/1.0) via w0, c
...
plot 	'./messwerte/strahlradien/strahlradien_80cm.txt' using 1:($3/2.0):2:($4/1.0) with xyerrorbars ls 1 t'Messwerte',\
