...
\begin{figure}[h]
	...
	\caption{Aufbau eines halbkreisförmigen Spektrometers}
...
Der maßgeblichste Nachteil dieses Spektrometers ist die fehlende Fokussierung in der Senkrechten.
...
\end{figure}
Im doppelt-fokussierenden Spektrometer werden (analog zum Halbkreisförmigen) Elektronen durch ein statisches Magnetfeld auf eine Kreisbahn gezwungen.
...
Die über \SI{100}{\second} gemessenen Zählraten $N$ für den Untergrund bei \SI{4}{\percent} Transmission sind in Tabelle \ref{tab:untergrund_na} festgehalten worden.
...
Diese wurde vor Beginn der Messung am Transformator umgepolt, da Natrium unter Aussendung eines Positrons zerfällt ($\beta^+$-Zerfall).
\begin{figure}[h]
	\centering
