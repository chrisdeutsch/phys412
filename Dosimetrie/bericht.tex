...
(Spannungsbereich: für höhere Röhrenspannung größere Kondensatorspannung, linearer Anstieg)
Der zweite Bereich ist der Ionisationsbereich, welcher durch ein Sättigungsverhalten gekennzeichnet wird.
...
(Abflachen für noch höhere Spannungen, Höhe des Plateaus für größere Spannungen)
Außerhalb unseres Messbereiches ($\SI{0}{V} \leq U_\mathrm{C} \leq \SI{400}{V}$) sind außerdem noch weitere Bereiche zu erwarten.
So kann beispielsweise bei noch höheren Kondensatorspannungen ionisierte Teilchen im elektrischen Feld soviel Energie gewinnen, dass diese weitere Ionen erzeugen, was zu einem verstärkten Ionisationsstrom führt (Proportionalitätsbereich). (Geiger und Gasentladung)
