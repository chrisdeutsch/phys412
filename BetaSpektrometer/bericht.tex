...
\begin{align}
	...
	\Delta n &= \sqrt{\frac{(\Delta N_\text{Korr})^2}{\left(U_\mathrm{H}^\mathrm{Korr}\right)^2} + \frac{N_\text{Korr}^2 \,(\Delta U_\mathrm{H}^\mathrm{Korr})^2}{\left(U_\mathrm{H}^\mathrm{Korr}\right)^2}}
\end{align}
