...
\begin{align}
	n \lambda = g \left( \cos(\alpha) - \cos(\beta) \right)
...
\begin{align}
	\frac{\lambda_\mathrm{KWN}}{\lambda} - 1 = \frac{1}{2} \frac{\frac{y_n^2 - y_0^2}{x_0^2}}{ \frac{x_0}{\sqrt{x_0^2 + y_0^2}} - \frac{x_0}{\sqrt{x_0^2 + y_n^2}} } - 1
\end{align}
