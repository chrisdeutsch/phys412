...
\begin{figure}
\centering
\input{./plots/aufspaltung/rot1.tex}
\caption{Isotopieaufspaltung rot 1}
\label{fig:aufspaltung_rot1}
\end{figure}

\begin{figure}
\centering
\input{./plots/aufspaltung/rot2.tex}
\caption{Isotopieaufspaltung rot 2}
\label{fig:aufspaltung_rot2}
\end{figure}

\begin{figure}
\centering
\input{./plots/aufspaltung/rot3.tex}
\caption{Isotopieaufspaltung rot 3}
\label{fig:aufspaltung_rot3}
\end{figure}

\begin{figure}
\centering
\input{./plots/aufspaltung/tuerkis1.tex}
\caption{Isotopieaufspaltung tuerkis 1}
\label{fig:aufspaltung_tuerkis1}
\end{figure}
