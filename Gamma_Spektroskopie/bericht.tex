...
\end{table}
Zur Bestimmung des Peak-to-Total Verhältnisses von \isotope[60]{Co} muss die Summe der Photopeaks im Spektrum berechnet werden.
...
\end{align}
berechnet werden.
Dies wurde in Tabelle \ref{tab:ptt_szinti} für die mittlere Energie der beiden Cobalt Linien sowie der von Caesium aufgetragen.
\begin{table}[ht]
	\centering
