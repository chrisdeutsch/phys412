...
\end{align}
Da die Photodiode die Intensität $I$ des auftreffenden Lichts misst und diese gegeben ist durch $I \propto E^2$ erhält man durch quadrieren von Gleichung \eqref{eq:superposition_efeld} und Anwendung der trigonometrischen Additionstheoreme das resultierende Frequenzspektrum der Intensität, welche aus den Frequenzen $\omega_1 + \omega_2, |\omega_1 - \omega_2|$ sowie den zweiten Harmonischen $2\omega_1, 2\omega_2$ besteht.
...
\end{itemize}
Der \textbf{Leistungspegel} des Generators wird auf $L = \SI{+7}{\dBm}$ eingestellt. Um diese logarithmische Größe in Einheiten einer Leistung zu erhalten, betrachtet man die Definition des Leistungspegels $L$: 
\begin{align}
...
Axialmodenabstand gegeben durch:
\begin{align}
	\Delta \nu &= \frac{c}{2 L}
\end{align}
Mit $\Delta \nu \approx \nu_\mathrm{HF}$:
...
\begin{figure}
\centering
\input{./plots/modenabstand/template.tex}
\end{figure}
