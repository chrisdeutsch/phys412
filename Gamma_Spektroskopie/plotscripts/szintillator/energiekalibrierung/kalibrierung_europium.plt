...
set output './plots/szintillator/energiekalibrierung/europium.tex'
...
fit[x=500:6838] t(x) './data/Szintillator/europium_bereinigt.txt' using 1:2:3 yerror via a1, a2, a3, a4, a5, a6, b1, b2, b3, b4, b5, b6, c1, c2, c3, c4, c5, c6, d
