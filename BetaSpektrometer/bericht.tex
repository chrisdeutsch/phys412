...
\begin{figure}[h]
	...
	\label{fig:hysterese}
\end{figure}
Bei jeder Messung wird dann das arithmetische Mittel von $U_\text{+}$ und $U_\text{-}$ berechnet und im Anschluss über diese wieder gemittelt, um einen guten Wert für die Offsetspannung $U_0$ zu erhalten.
