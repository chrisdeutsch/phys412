...
\hyphenation{Re-so-na-tor Mo-den-ab-stand Re-so-na-tor-län-ge Spek-t-ro-me-ter Szin-til-la-tions-de-tek-tors}
...
\begin{figure}[h]
	\centering
	\input{./plots/szintillator/energiekalibrierung/cobalt2.tex}
	\caption{Gaußfit Cobalt}
	\label{fig:kalibrierung_co}
\end{figure}

\begin{figure}[h]
	\centering
	\input{./plots/szintillator/energiekalibrierung/caesium.tex}
	\caption{Gaußfit Caesium}
	\label{fig:kalibrierung_cs}
\end{figure}
...
Da beide Signale von unabhängigen Ereignissen stammen, kann leider nicht verifiziert werden, dass die Impulshöhe am Hauptverstärker proportional zur im Photomultiplier gelösten Ladung, welche wiederum proportional zur Fläche über dem Signal am Vorverstärker ist.
