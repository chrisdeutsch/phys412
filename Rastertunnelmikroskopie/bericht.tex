...
\end{equation}
Wir messen die ausgedruckte Kantenlänge der Abbildung \ref{fig:ref_ptir} mit einem Lineal:
\begin{equation*}
...
\end{align*}
Mit diesem Wert erhalten wir für die Vergrößerung der des RTM:
\begin{align*}
...
\caption{Konstruktion der hexagonalen Kohlenstoffringe im Bild des RTM. In den zwei oberen Ebenen überlappende Kohlenstoffatome sind in rot markiert. Die Zahlen dienen der Linienidentifikation in Tabelle (REFERENZ)}
\label{fig:laengen}
\end{figure}
...
\end{figure}
Zur Bestimmung des Bindungswinkels legen wir für jede Winkelmessung zwei Hilfsgeraden durch die Maxima des Bildes (siehe Abbildung REF).
