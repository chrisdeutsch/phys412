...
\label{sec:nachweis}
Zum Nachweis von Röntgenstrahlung werden in diesem Versuch das Geiger-Müller-Zählrohr, Röntgenenergiedetektor und Röntgenfilm verwendet.
...
In diesem Versuchsteil konnten wir mithilfe des \emph{X-Ray Data Booklets} das Anodenmaterial der Röntgenröhre anhand des charakteristischen Spektrum erfolgreich Wolfram zuordnen.
...
Anschließend tragen wir die Linenenergie $E_\mathrm{Lit.}$ der Linien gegen ihren Peakschwerpunkt $n$ auf und passen eine Gerade an die Messwerte an (Least-Squares).
