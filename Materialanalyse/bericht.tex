...
Die zwei nah beieinander liegenden Peaks von Eisen (das zweite bei etwa \SI{7000}{\electronvolt}) lassen sich wie im Kalibrier- und Referenzspektrum nicht auflösen, wodurch der Knick bei der oben genannten Energie erklärt werden kann.
Das weiter links liegende Peak kann mit der abgelesenen Energie und \cite{booklet} zu Chrom bestimmt werden, genau wird das sehr kleine Peak bei ca. \SI{10}{\kilo\electronvolt} zu Wolfram zugeordnet, da es im Referenzspektrum kaum zu erkennen ist (entspricht laut \cite{booklet} der $L\beta_1$ Linie bei \SI{9672}{\electronvolt}).
