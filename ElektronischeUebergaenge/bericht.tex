...
\end{align}
Gemäß Gleichung \ref{eq:normaler_zeeman_auswertung} entspricht die Steigung der Ursprungsgeraden im $|\Delta E|$ -- $\bar{B}$-Graph dem Bohrschen Magneton. Wir bilden den varianzgewichteten Mittelwert der Steigungen und erhalten:
\begin{align}
