...
\subsection{Hypothesis of the Asteroids Orbit}
...
For unknown reasons the minimization function from Python's \texttt{scipy.optimize} returned the initial guess after a long computation time.
As a possible cause for this behaviour, ...BLA 
