...
\begin{figure}[h]
	...
	\caption{Absorber 1 Zr}
	\label{fig:absorber_1_zr}
\end{figure}
...
Mit den gerade bestimmten Absorptionskoeffizienten kann so die Dicke des Aluminiums im zweiten Absorbersatz bestimmt werden, die gleich groß ist wie die Dicke der anderen Absorberelemente.
...
\begin{align}
	d&=-\frac{\log(T)}{\mu} \label{eq:dicke}\\
	\Delta d &= \sqrt{\frac{\log^2(T)\,(\Delta\mu)^2}{\mu^4} + \frac{(\Delta T)^2}{T^2\mu^2}}
\end{align}
...
\begin{align}
	\mu&=-\frac{\log(T)}{d} \\
	\Delta\mu &= \sqrt{\frac{\log^2(T)\,(\Delta d)^2}{d^4} + \frac{(\Delta T)^2}{T^2d^2}}
\end{align}
