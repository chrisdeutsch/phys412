...
set output './plots/szintillator/energiekalibrierung/caesium.tex'
...
fit[x=3200:4200] t(x) './data/Szintillator/caesium_bereinigt.txt' using 1:2:3 yerror via a1, b1, c1, d
