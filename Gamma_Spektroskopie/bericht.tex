...
Auch der exponentielle Abfall mit der Signaldauer $\Delta t = \SI{137 +- 5}{\micro\second}$ (von 10 \% auf 10\%) ist wiederzuerkennen.
ERKLÄREN.
\begin{figure}[h]
	\centering
...
\end{figure}
Betrachtet man nun das Signal am Hauptverstärker in Abbildung \ref{fig:signal_ger_haupt}\\
Amplitude: $\Delta U = \SI{5.1 +- 0.2}{\volt}$\\
Signaldauer: $\Delta t = \SI{22 +- 1}{\micro\second}$\\
\begin{figure}[h]
	\centering
