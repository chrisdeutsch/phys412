...
Da unsere beiden Magnetfeldkalibrierungen eine kleine Abweichung im Bereich hoher Ströme aufweisen, entscheiden wir uns dafür die die beiden Kalibrationen varianzgewichtet zu Mitteln.
\begin{align*}
	\bar{x} &= \frac{\sum_i \frac{x_i}{\sigma_i^2}}{\sum_i \frac{1}{\sigma_i^2}}\\
	\sigma_{\bar{x}} &= \sqrt{\frac{1}{\sum_i \frac{1}{\sigma_i^2}}}
\end{align*}
...
\begin{table}[h]
	\centering
	\input{./tables/aufloesung_transversal.tex}
...
\begin{table}[h]
	\centering
	\input{./tables/aufloesung_longitudinal.tex}
...
Ein Elektron dieser Energie kann bei \SI{2}{\volt} Gegenspannung noch registriert werden, bei \SI{3}{\volt} nicht mehr, weswegen der Anodenstrom im zweiten Fall geringer ausfällt.
